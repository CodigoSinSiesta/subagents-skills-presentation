...
<div class="swiper-slide" bind:this={slideElement}>
  ...
  <div class="slide-content">
    <div class="eyebrow">
      ...
      <span>Subagentes y Skills · 2025</span>
    </div>

    <h1 class="title">
      Orquestando<br />
      <span class="highlight">inteligencia</span>
    </h1>

    <p class="subtitle">
      Subagentes, skills y la arquitectura de<br />
      agentes que escalan.
    </p>
    ...
    <div class="tools-row">
      ...
      <span class="tool-badge">CLAUDE.md</span>
      <span class="tool-badge">AGENTS.md</span>
      <span class="tool-badge highlight-badge">Skills</span>
    </div>
